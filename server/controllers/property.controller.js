...
const getAllProperties = async (req,res) => {
    ...
    // default value for title_like is set to empty string ""
    ...
    try {
        ...
        // allows to expose the 'x-total-count' header to the front end
...
const createProperty = async (req,res) => {
    ...
    try {
        ...
        // Start a new session (makes the transaction atomic)....
